...
(function (Gefrierschrank) {
    var heutigesDatum = Date.now();
    var datumString = heutigesDatum.toString();
    //Zugriff auf Form Elemente
    var newGefriergutForm = document.getElementById("newGefriergut");
    var saveButton = document.getElementById("saveButton");
    saveButton.addEventListener("click", saveGefriergut);
    function saveGefriergut() {
        return __awaiter(this, void 0, void 0, function () {
            var formData, url, query, response, answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        formData = new FormData(document.forms[0]);
                        url = "https://davidqgissose2021.herokuapp.com/saveGefriergut";
